...
if CLIENT then
	...
	function HUDELEMENT:DrawBar(x, y, w, h, alpha, item)
		...
		local interpolColor = Color(tipColor.r * 0.5 + self.basecolor.r * 0.5, tipColor.g * 0.5 + self.basecolor.g * 0.5, tipColor.b * 0.5 + self.basecolor.b * 0.5, tipColor.a * 0.5 + self.basecolor.a * 0.5)
		surface.SetDrawColor(interpolColor.r, interpolColor.g, interpolColor.b, alpha)
		surface.DrawRect(x + self.tipsize, y, self.iw, h)
		...
		--draw icon
		draw.FilteredShadowedTexture(x, y, h, h, icon, alpha, COLOR_WHITE, self.scale)
